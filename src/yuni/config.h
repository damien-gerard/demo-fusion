...
# define YUNI_VERSION_STRING           "0.2.1-debug"
# define YUNI_VERSION_LITE_STRING      "0.2.1"

/*! The flags used to compile Yuni */
# define YUNI_COMPILED_WITH_CXX_FLAGS  " -D_REENTRANT -DXUSE_MTSAFE_API -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -fPIC  -std=c++14 -stdlib=libstdc++ -fvisibility=hidden -g -gfull -ggdb -ggdb3 -W -Wall -Wextra -Wunused-parameter -Wconversion -Woverloaded-virtual -Wundef -Wfloat-equal -Wmissing-noreturn -Wcast-align -Wuninitialized -Wdocumentation        "
/*! The target used to compile Yuni (debug/release) */
# define YUNI_COMPILED_WITH_TARGET     "debug"

/*! List of all modules */
# define YUNI_MODULE_LIST              "algorithms;vm;marshal;vfs;vfs-local;media;devices;display;keyboard;mouse;graphics;opengl;ui;dbi;dbi-sqlite;net;netserver;netclient;ldo;uuid;docs;parser"
